...
from models.modeling_gpt2_innerdetox import GPT2LMHeadModelInnerDetox
...
if __name__ == '__main__':
    ...
    for l in range(0, 36):
        ...
        ori_model = GPT2LMHeadModelInnerDetox.from_pretrained(model_path, attn_implementation="sdpa")
        ori_model.to(device)
        tox_model = GPT2LMHeadModelInnerDetox.from_pretrained(model_path, attn_implementation="sdpa")
