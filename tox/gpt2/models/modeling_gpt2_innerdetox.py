...
class GPT2LMHeadModelInnerDetox(GPT2PreTrainedModel, GenerationMixin):
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        if self.layer == "full":
            attention_name = [f"transformer.h.{l}.attn.before_mergehead" for l in range(1,36)]
            adap = attention_name
        else:
            adap = f"transformer.h.{self.layer+1}.attn.before_mergehead"
        ...
        while self._has_unfinished_sequences(
            ...
            if self.layer == "full" or self.layer == 35:
